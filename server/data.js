...
function updatePosition(payload) {
  ...
  if (state.positions[payload.deviceId] === undefined) {
    state.positions[payload.deviceId] = {
  ...
  if (payload.hasOwnProperty("batteryLevel")) {
    state.positions[payload.deviceId]["attributes"]["batteryLevel"] =
      payload.batteryLevel;
  }
  if (payload.hasOwnProperty("gimbal")) {
    state.positions[payload.deviceId]["attributes"]["gimbal"] = payload.gimbal;
  }
  if (payload.hasOwnProperty("uav_state")) {
    state.positions[payload.deviceId]["attributes"]["protocol"] =
      payload.protocol;
    state.positions[payload.deviceId]["attributes"]["mission_state"] =
      payload.mission_state;
    state.positions[payload.deviceId]["attributes"]["wp_reached"] =
      payload.wp_reached;
    state.positions[payload.deviceId]["attributes"]["uav_state"] =
      payload.uav_state;
    state.positions[payload.deviceId]["attributes"]["landed_state"] =
      convert_landed_state(payload.protocol, payload.landed_state);
  }
