...
export const COMMAND_CATALOG = {
  ...
  [CommandType.CUSTOM]: { requires: null, dispatch: Dispatch.SERVICE, rosService: undefined, payload: Payload.ATTRIBUTES },
  ...
  [CommandType.SINCRONISE_FILES]: { requires: ServiceKey.SINCRONIZE, dispatch: Dispatch.SERVICE, rosService: ServiceKey.SINCRONIZE, payload: Payload.NONE },
  [CommandType.RESUME_MISSION]: { requires: ServiceKey.RESUME_MISSION, dispatch: Dispatch.SERVICE, rosService: ServiceKey.RESUME_MISSION, payload: Payload.NONE },
  [CommandType.STOP_MISSION]: { requires: ServiceKey.STOP_MISSION, dispatch: Dispatch.SERVICE, rosService: ServiceKey.STOP_MISSION, payload: Payload.NONE },
  [CommandType.PAUSE_MISSION]: { requires: ServiceKey.PAUSE_MISSION, dispatch: Dispatch.SERVICE, rosService: ServiceKey.PAUSE_MISSION, payload: Payload.NONE },
  [CommandType.SETUP_CAMERA]: { requires: ServiceKey.SETUP_CAMERA, dispatch: Dispatch.SERVICE, rosService: ServiceKey.SETUP_CAMERA, payload: Payload.ATTRIBUTES },
  ...
  [CommandType.CAMERA_FILE_DOWNLOAD]: { requires: ServiceKey.CAMERA_FILE_DOWNLOAD, dispatch: Dispatch.SERVICE, rosService: ServiceKey.CAMERA_FILE_DOWNLOAD, payload: Payload.ATTRIBUTES },
  [CommandType.CAMERA_FILE_LIST]: { requires: ServiceKey.CAMERA_FILE_LIST, dispatch: Dispatch.SERVICE, rosService: ServiceKey.CAMERA_FILE_LIST, payload: Payload.ATTRIBUTES },
  [CommandType.UPLOAD_MISSION]: { requires: ServiceKey.UPLOAD_MISSION, dispatch: Dispatch.SERVICE, rosService: ServiceKey.UPLOAD_MISSION, payload: Payload.ATTRIBUTES },
  [CommandType.NAVIGATE_TO_POSE]: { requires: ServiceKey.NAVIGATE_TO_POSE, dispatch: Dispatch.SERVICE, rosService: ServiceKey.NAVIGATE_TO_POSE, payload: Payload.ATTRIBUTES },
  [CommandType.THREAT_CONFIRMATION]: { requires: ServiceKey.THREAT_CONFIRMATION, dispatch: Dispatch.SERVICE, rosService: ServiceKey.THREAT_CONFIRMATION, payload: Payload.NONE },
  [CommandType.THREAT_DEFUSE]: { requires: ServiceKey.THREAT_DEFUSE, dispatch: Dispatch.SERVICE, rosService: ServiceKey.THREAT_DEFUSE, payload: Payload.NONE },
};
