  ...
  (function (amrl_msgs) {
    ...
    (function (RobofleetSubscriptionConstants) {
      ...
      (function (action_unsubscribe) {
        ...
        (action_unsubscribe =
          RobofleetSubscriptionConstants.action_unsubscribe || (RobofleetSubscriptionConstants.action_unsubscribe = {}))
      );
    })(
      (RobofleetSubscriptionConstants =
        amrl_msgs.RobofleetSubscriptionConstants || (amrl_msgs.RobofleetSubscriptionConstants = {}))
    );
  ...
  (function (amrl_msgs) {
    ...
    (function (RobofleetSubscriptionConstants) {
      ...
      (function (action_subscribe) {
        ...
        (action_subscribe =
          RobofleetSubscriptionConstants.action_subscribe || (RobofleetSubscriptionConstants.action_subscribe = {}))
      );
    })(
      (RobofleetSubscriptionConstants =
        amrl_msgs.RobofleetSubscriptionConstants || (amrl_msgs.RobofleetSubscriptionConstants = {}))
    ...
    (function (NavSatFixConstants) {
      ...
      (function (covariance_type_unknown) {
        ...
        (covariance_type_unknown =
          NavSatFixConstants.covariance_type_unknown || (NavSatFixConstants.covariance_type_unknown = {}))
      );
    ...
    (function (NavSatFixConstants) {
      ...
      (function (covariance_type_approximated) {
        ...
        (covariance_type_approximated =
          NavSatFixConstants.covariance_type_approximated || (NavSatFixConstants.covariance_type_approximated = {}))
      );
    })((NavSatFixConstants = sensor_msgs.NavSatFixConstants || (sensor_msgs.NavSatFixConstants = {})));
  })((sensor_msgs = fb.sensor_msgs || (fb.sensor_msgs = {})));
})(fb || (exports.fb = fb = {}));
    ...
    (function (NavSatFixConstants) {
      ...
      (function (covariance_type_diagonal_known) {
        ...
        (covariance_type_diagonal_known =
          NavSatFixConstants.covariance_type_diagonal_known || (NavSatFixConstants.covariance_type_diagonal_known = {}))
      );
    })((NavSatFixConstants = sensor_msgs.NavSatFixConstants || (sensor_msgs.NavSatFixConstants = {})));
  })((sensor_msgs = fb.sensor_msgs || (fb.sensor_msgs = {})));
})(fb || (exports.fb = fb = {}));
    ...
    (function (NavSatFixConstants) {
      ...
      (function (covariance_type_known) {
        ...
        (covariance_type_known =
          NavSatFixConstants.covariance_type_known || (NavSatFixConstants.covariance_type_known = {}))
      );
    })((NavSatFixConstants = sensor_msgs.NavSatFixConstants || (sensor_msgs.NavSatFixConstants = {})));
  })((sensor_msgs = fb.sensor_msgs || (fb.sensor_msgs = {})));
})(fb || (exports.fb = fb = {}));
  ...
  (function (nav_msgs) {
    class Odometry {
      ...
      pose(obj) {
        var offset = this.bb.__offset(this.bb_pos, 10);
        return offset
          ? (obj || new fb.geometry_msgs.PoseWithCovariance()).__init(this.bb.__indirect(this.bb_pos + offset), this.bb)
          : null;
      }
      /**
