...
export const formatBoolean = (value) => (value ? "sharedYes" : "sharedNo");
...
export const formatAlarm = (value) =>
  value ? prefixString("alarm", value) : "";
...
export const formatCourse = (value) => {
  ...
  return value.toFixed() + courseValues[Math.floor(normalizedValue / 45)];
};
