                    ...
                    <Fragment key={"fragment-action-" + index_ac}>
                      <div>
                        ...
                        <IconButton
                          ...
                          onClick={() =>
                            Removing_action(index, index_wp, action_key)
                          }
            ...
            <Box textAlign="center">
              {newactionmenu ? (
                ...
                <div>
                  ...
                  />
                  <div>
                    <Button onClick={() => setnewactionmenu(true)}>
                      Cancel
                    </Button>
                    <Button onClick={() => setnewaction(index, index_wp)}>
                      Add
                    </Button>
                  </div>
                </div>
