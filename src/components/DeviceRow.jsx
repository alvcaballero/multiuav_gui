        ...
        {position && (
          <>
            {position.attributes.hasOwnProperty("ignition") && (
              <Tooltip
                title={`${"positionIgnition"}: ${formatBoolean(
              ...
              <Tooltip title={`${"speed"}: ${position.speed}`}>
                <IconButton size="small">
                  <div style={{ fontSize: "0.9rem" }}>
                    {" "}
                    V {Math.round(position.speed)}m/s
                  </div>
                </IconButton>
              </Tooltip>
            )}
            {position.hasOwnProperty("altitude") && (
              <Tooltip
                title={`${"altitude"}: ${Math.round(position.altitude)}`}
              >
                <IconButton size="small">
                  <div style={{ fontSize: "0.9rem" }}>
                    H {Math.round(position.altitude)}m
                  </div>
                </IconButton>
              </Tooltip>
            )}
            {position.attributes.hasOwnProperty("batteryLevel") && (
              <Tooltip
                title={`${"BatteryLevel"}: ${formatPercentage(
