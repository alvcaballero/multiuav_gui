...
const RouteTrackingRow = ({ route, devicesMap }) => {
  ...
  const showEstimate = route.wpEstimate !== null && route.wpEstimate !== undefined && route.wpEstimate !== route.currentWp;
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 0.25 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', flexShrink: 0, ml: 1 }}>
          ...
          <Chip
            label={style.label}
            size="small"
            sx={{ ml: 1, height: 18, fontSize: '0.6rem', backgroundColor: style.color, color: '#fff' }}
          />
        </Box>
      </Box>
      <LinearProgress
