...
import MapCurrentLocation from '../Mapview/MapCurrentLocation';
import MapGeofenceEdit from '../Mapview/draw/MapGeofenceEdit';
import GeofencesList from './GeofencesList';
import MapGeocoder from '../Mapview/geocoder/MapGeocoder';
...
const GeofencesPage = () => {
    ...
    const handleFile = (event) => {
        ...
        reader.onload = async () => {
            ...
            const newItem = { name: "sharedGeofence", area };
            try {
